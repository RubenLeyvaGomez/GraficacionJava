...
public class CL_ESPACIO_GRAFICO extends JFrame
{
  ...
  public CL_ESPACIO_GRAFICO (CL_TRAZADOR grf, int w, int h)
    ...
    public void dibuja_espacio_geometrico3D(CL_TRAZADOR grf)
    {
        trazador = grf;
        repaint();
    }
    
    public void dibuja_plano(CL_TRAZADOR grf)
    {
        trazador = grf;
        repaint();
    }
    public void dibuja_figura(CL_TRAZADOR grf)
    {
    ...
    public void dibuja_cubo(CL_TRAZADOR grf)
    {
        trazador = grf;
        repaint();
    }
